...
<coverage>
  <packages>
    <package name="github.com/trick77/rongo/internal/auth">
      <classes>
    ...
    <package name="github.com/trick77/rongo/cmd/rongo">
      <classes>
        <class name="main" filename="cmd/rongo/main.go">
...
<coverage>
  <packages>
    <package name="github.com/trick77/rongo/internal/lines">
      <classes>
