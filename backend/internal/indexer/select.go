...
// ... DO NOT EDIT", Facebook's "@generated", .NET's "<auto-generated>", and
// the plain sentence. Checked against the head of the file because
// generators put it in the first lines.
var generatedMarker = regexp.MustCompile(`(?i)code generated .{0,60}do not edit|@generated|auto-generated|automatically generated`)
...
// repository's structure from them, and a parent pom or a workspace
// angular.json outgrows any sensible ceiling.
...
// or json/xml above the ceiling, which names the ceiling so the operator who
// misses a file knows which knob to raise.
...
// isManifest reports a file internal/units reads the repository's structure
// from, plus the tsconfig family that carries the path aliases.
func isManifest(base string) bool {
	return manifestFiles[base] || (strings.HasPrefix(base, "tsconfig") && strings.HasSuffix(base, ".json"))
}
