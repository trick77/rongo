...
//
// Two shapes are NOT the marker, and bare "@generated" matched both. A
// quote before it is a name, not a tag: `from '@generated'` is the
// TypeScript alias schadenmeldung-ui gives its generated client, and it
// dropped 278 hand-written files there. Without \b, "@GeneratedValue" on a
// JPA @Id matched too, dropping all 43 entities of schadenmeldung-service.
// Both times the code answering the question was never indexed.
var generatedMarker = regexp.MustCompile(`(?i)code generated .{0,60}do not edit|(?:^|[^'"` + "`" + `])@generated\b|<auto-generated`)
